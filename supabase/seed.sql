...
insert into projects (id, owner_id, name, address, lat, lon, intake_mode, status,
...
values
  ...
  (
    ...
    3.0997, 101.6175, 'drone_terra', 'ready',
  ...
  (
    ...
    3.0863, 101.5325, 'photos', 'processing',
  ...
  (
    ...
    2.918, 101.652, 'drone_video', 'draft',
  ...
  (
    ...
    5.293, 100.275, 'drone_terra', 'failed',
